alert ("Hello!");
        ...
        function updateTime () {
            ...
            losAngelesTimeElement.innerHTML = losAngelesTime.format("h:mm:ss:SSS  [<small>AM</small>]");
...
//sydney
            ...
            sydneyTimeElement.innerHTML = sydneyTime.format("h:mm:ss:SS [<small>AM</small>]");
